...
void CS123Shader::applyMaterial(const CS123SceneMaterial &material) {
    //std::cout << "Ambient: " << material.cAmbient.r << ":"<< material.cAmbient.g << ":"<< material.cAmbient.b << std::endl;
    //std::cout << "Diffuse: " << material.cDiffuse.r << ":"<< material.cDiffuse.g << ":"<< material.cDiffuse.b << std::endl;
...
void CS123Shader::applyTexture(const CS123SceneFileMap &material) {
    setUniform("repeatUV", glm::vec2({material.repeatU,material.repeatV}));
    setUniform("useTexture", material.isUsed);
}
