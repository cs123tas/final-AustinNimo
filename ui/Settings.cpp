...
void Settings::loadSettingsOrDefaults() {
    ...
    // Canvas
    canvasWidth = s.value("canvasWidth", 500).toInt();
    canvasHeight = s.value("canvasHeight", 500).toInt();
    ...
    minStartBrightness = s.value("minStartBrightness", 0).toInt();
    maxStartBrightness = s.value("maxStartBrightness", 255).toInt();
    minEBrightness = s.value("minEBrightness", 0).toInt();
    maxEBrightness = s.value("maxEBrightness", 255).toInt();
    midrange = s.value("gamma", .5).toDouble();
    ...
    cameraFar = s.value("cameraFar", 500).toDouble();
...
void Settings::saveSettings() {
    ...
    s.setValue("minStartBrightness", minStartBrightness);
    s.setValue("maxStartBrightness", maxStartBrightness);
    s.setValue("minEBrightness", minEBrightness);
    s.setValue("maxEBrightness", maxEBrightness);
    s.setValue("midrange", midrange);
    ...
    // Camtrans
    s.setValue("useOrbitCamera", true);
