...
struct Settings {
    ...
    // Canvas
    int canvasWidth;     // The initial width of the canvas
    int canvasHeight;     // The initial height of the canvas
    ...
    unsigned char minStartBrightness;       // minimum brightness before auto balance
    unsigned char maxStartBrightness;       // maximum brightness before auto balance
    unsigned char minEBrightness;           // minimum brightness after auto balance
    unsigned char maxEBrightness;           // maximum brightness after auto balance
    float midrange;                  // gamma to use for auto balance
